...
![돌 친구 랭킹 실제 서비스 화면](./docs/images/ranking-qa-before.png)

실제 사용 화면을 확인하면서 일반 일정용 돌곰이 문구가 랭킹 상태와 맞지 않고, 1명만 참여한 화면에서 1위 카드의 빈 공간이 지나치게 크게 보이는 문제를 발견했습니다. 이후 랭킹 화면에는 전용 안내 박스와 돌곰이를 배치하고, 주간·누적 집계 기준이 선택 상태에 맞게 표시되도록 개선했습니다.
