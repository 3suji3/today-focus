...
[서비스 체험하기](https://today-focus.eunsil5523.chatgpt.site) · [GitHub 저장소](https://github.com/3suji3/today-focus)

</div>

![오늘 뭐하지 메인 화면](./docs/images/today-focus-main.jpg)
...
- 실제 사용 로그를 바탕으로 추천 전략별 만족도 측정
- 키보드 탐색과 스크린 리더 시나리오를 포함한 접근성 회귀 테스트 확대
- 브라우저 기반 E2E 테스트로 로그인 이후 주요 사용자 흐름 자동화
- 설정·완료 기록 내보내기와 데이터 이전 기능
